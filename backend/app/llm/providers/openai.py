...
def generate_openai(prompt: str, system_prompt: Optional[str] = None, json_format: bool = False) -> str:
    """Invokes the OpenRouter (OpenAI-compatible) API provider."""
    from app.core.settings import settings
    original = settings.ACTIVE_LLM_PROVIDER
    settings.ACTIVE_LLM_PROVIDER = "openrouter"
    try:
